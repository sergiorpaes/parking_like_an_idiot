        ...
        {view === 'camera' && (
          <div className="fixed inset-0 z-[200] bg-black flex flex-col overflow-hidden">
            <div className="relative flex-1 bg-zinc-950 flex flex-col items-center justify-center pt-20">
              ...
              {/* Zoom Slider */}
              <div className="absolute bottom-36 left-0 right-0 flex items-center justify-center gap-4 z-20 px-8">
                <input
                  type="range"
                  min="1"
                  max="5"
                  ...
                  className="w-64 h-1 bg-white/20 rounded-lg appearance-none cursor-pointer accent-white"
                />
              </div>
                ...
                <div className="flex flex-col items-center gap-6 py-10">
                  <div className="text-center space-y-2">
                    ...
                    <p className="opacity-70 text-sm font-medium italic max-w-xs mx-auto">
                      ...
                      {lastProcessedReport?.rejectionReason === 'NOT_A_VEHICLE' && t('noVehicle')}
                      {!['LOW_QUALITY', 'POOR_QUALITY', 'UNCERTAIN_VIOLATION', 'NO_VIOLATION', 'NOT_A_VEHICLE'].includes(lastProcessedReport?.rejectionReason || '') && t('systemNoVehicle')}
                    </p>
                  </div>
